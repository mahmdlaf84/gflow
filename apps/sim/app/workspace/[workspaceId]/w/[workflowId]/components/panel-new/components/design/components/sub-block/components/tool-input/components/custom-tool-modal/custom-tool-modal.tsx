...
import { CodeEditor } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/panel-new/components/design/components/sub-block/components/tool-input/components/code-editor/code-editor'
